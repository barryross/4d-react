...
<section id="about">
  ...
  <div className="card about wrapper">
        {/* <div> */}
          <img src="/images/barryross.jpg" alt="image of Barry Ross"/>
         {/* </div> */}
    ...
    <div class="cta">
      <h4>I am currently available for light contract work, <br/>as well as for consulting regarding technical project scope and breakdown </h4>
    </div>
